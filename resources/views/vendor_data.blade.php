...
<head>
    ...
    <!-- user-details css -->
    <link rel="stylesheet" href="assets/admin_deshboard/css/userdetails.css">
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <head>
                        <meta charset="UTF-8">
                        <meta name="viewport" content="width=device-width, initial-scale=1.0">
                        <title>Modern Data Table UI</title>
                            ...
                            <table class="modern-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Display Name</th>
                                        <th>Email</th>
                                        <th>Password</th> <!-- Not recommended to display password -->
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $register->display_name }}</td>
                                        <td>{{ $register->email_address }}</td>
                                        <td>{{ $register->password }}</td>
                                        <!-- Avoid displaying password in plaintext -->
