...
<body>
    ...
    <div class="main-section">
        ...
        <div class="right-section">
            ...
            <div class="item-display" style="position: relative;">
                ...
                <div id="text-display" style="position: absolute; margin-left: 270px; margin-top: 203px;"></div>
    ...
    <div class="head-box">
        <p class="mainheading">CUSTOM CRICKET KIT</p>
    ...
    <form>
        <div class="flex-form">
            ...
            <div class="form-column">
                ...
                <div class="form-group">
                    ...
                    <select id="kit" name="kit" onchange="togglePantsSize()">
        ...
        <script>
            document
                .getElementById("inside-collar-message")
                ...
                <table class="team-roster-table">
                    <thead>
                        <tr>
                            ...
                            <th>Number:</th>
                            <th>Shirt Size</th>
                            <th class="pants-size-td">Pants Size</th>
                            <th>Quantity </th>
                            <!-- <th>GK</th> -->
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="pants-size-td">
                                <select class="pants size">
                                    <option value="">--</option>
                                    <option value="youth-xs">Youth XS</option>
                                    <option value="youth-s">Youth S</option>
                                    <option value="youth-m">Youth M</option>
        ...
        <div class="team-form-container" id="staff-size-guide">
            <p class="size-guide" style="margin-left: -150px">
                <i class="fa-solid fa-ruler"></i> Staff Size Guide
            </p>
            <form>
                <table class="team-roster-table">
                    <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" class="Quantity-input" placeholder="0" min="1" />
                            </td>
                        </tr>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const staffFitTypeGroup = document.getElementById(
                "staff-fit-type-group"
            );
            const staffCollarTypeGroup = document.getElementById(
    ...
    <script>
        function togglePantsSize() {
            var kit = document.getElementById("kit").value;
            var pantsSizeTds = document.querySelectorAll(
                ".pants-size-td"); // Select all <td> with class 'pants-size-td'

            pantsSizeTds.forEach(function(td) {
                if (kit === "shirt-only") {
    ...
    <script>
        //for selecting and hiding pants
