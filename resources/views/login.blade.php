                    ...
                    <div class="card overflow-hidden">
                        <div class="row g-0">
                            <div class="col-lg-6 d-none d-lg-block p-2">
                                <img src="assets/images/auth-img2.jpg" alt="" class="img-fluid rounded h-100">
                            </div>
                            <div class="col-lg-6">
                                <div class="d-flex flex-column h-100">
                                    <div class="auth-brand p-4">
                                        ...
                                        <a href="#" class="logo-dark">
                                            <img src="assets/images/Logo767.png" alt="dark logo" height="120"
                                        ...
                                        <form method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="email" id="emailaddress" required=""
                                                    placeholder="Enter your email" name="email_address">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-0 text-start">
                                                <button class="btn btn-soft-primary w-100" type="submit"><i
                                                        class="ri-login-circle-fill me-1" style="color: #fff;"></i>
                                                    <span style="color: #fff;" class="fw-bold">Log
                                                        In</span> </button>
                                            </div>
